...
# installed.
TCL_PREFIX='C:/TvsLearning/ManiFoldLearning/git-demo/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/TvsLearning/ManiFoldLearning/git-demo/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/TvsLearning/ManiFoldLearning/git-demo/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/TvsLearning/ManiFoldLearning/git-demo/env\Library\include'
...
TCL_PACKAGE_PATH='C:/TvsLearning/ManiFoldLearning/git-demo/env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/TvsLearning/ManiFoldLearning/git-demo/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/TvsLearning/ManiFoldLearning/git-demo/env\Library\lib\tclstub86.lib'
